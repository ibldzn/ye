...
<head>
  ...
  <title>Pelayanan Masyarakat - Admin | Petugas</title>
</head>
<body class="bg-dark">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a href="petugas.php" role="tab" class="nav-link active">Petugas</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4 text-white">List Petugas</h1>
